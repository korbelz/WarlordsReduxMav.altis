...
private _lineone = parseText "<a href='https://github.com/korbelz/WarlordsReduxMav.altis'>Click HERE: To report bugs, and follow development</a>";
...
"Welcome to Warlords Maverick! Please read below..." hintC [_lineone, _linethree, _linefour, _linefive, _linetwo]; 
