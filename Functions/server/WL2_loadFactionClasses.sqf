...
BIS_WL_factionUnitClasses = [
	[
		"B_Soldier_F",			1, //rifleman, default 100
		"B_Soldier_GL_F",		1, //Grenadir, default 80
		"B_soldier_AR_F",		50, //Autorifleman, default 70
		"B_soldier_AAR_F",		1, //Asst Autorifleman, default 70
		"B_Soldier_TL_F",		1, //Team leader. default 30
		"B_soldier_M_F",		1, //Marksman, default 20
		"B_soldier_LAT_F",		1, //PCML, default 20
		"B_soldier_LAT2_F",		50, //MAAWS? , default 20
		"B_Soldier_A_F",		1, //Ammo, default 20
		"B_Soldier_SL_F",		1, //Squad leader, default 15
		"B_medic_F",			1, //Medic, default 15
		"B_soldier_repair_F",	1, //Repair, default 15
		"B_soldier_AT_F",		1, //Titan AT, default 15
		"B_soldier_AA_F",		100, //Titan AA, default 15
		"B_engineer_F",			1, //engineer, default 15
		"B_soldier_AAT_F",		1, //Asst AT, default 15
		"B_soldier_AAA_F",		1, //Asst AA, default 15
		"B_Sharpshooter_F",		1, //762x51, default 15
		"B_HeavyGunner_F",		1, //338, default 15
		"B_soldier_exp_F",		1, //APERS, default 10
		"B_officer_F",			1, //officer, default 10
		"B_spotter_F",			1, //spotter, default 10
		"B_diver_F",			1, //spotter, default 10
		"B_sniper_F",			1 //sniper, default 10
	],
	[
		"O_Soldier_F",			1, //rifleman, default 100
		"O_Soldier_GL_F",		1, //Grenadir, default 80
		"O_Soldier_AR_F",		50, //Autorifleman, default 70
		"O_Soldier_AAR_F",		1, //Asst Autorifleman, default 70
		"O_Soldier_TL_F",		1, //Team leader. default 30
		"O_officer_F",			1, //officer, default 10
		"O_soldier_M_F",		1, //Marksman, default 20
		"O_Soldier_LAT_F",		50, //RPG32, default 20
		"O_Soldier_A_F",		1, //Ammo, default 20
		"O_Soldier_SL_F",		1, //Squad leader, default 15
		"O_Soldier_AAT_F",		1, //Asst AT, default 15
		"O_Soldier_AAA_F",		1, //Asst AA, default 15
		"O_Sharpshooter_F",		1, //93x64, default 15
		"O_HeavyGunner_F",		1, //93x64, default 15
		"O_Soldier_AT_F",		1, //Titan AT, default 15
		"O_Soldier_AA_F",		100, //Titan AA, default 15
		"O_engineer_F",			1, //engineer, default 15
		"O_medic_F",			1, //Medic, default 15
		"O_soldier_repair_F",	1, //Repair, default 15
		"O_soldier_exp_F",		1, //APERS, default 10
		"O_spotter_F",			1, //spotter, default 10
		"O_diver_F",			1, //spotter, default 10
		"O_sniper_F",			1 //sniper, default 10
	],
	[
		"I_soldier_F",			1, //rifleman, default 100
		"I_Soldier_GL_F",		1, //Grenadir, default 80
		"I_Soldier_AR_F",		50, //Autorifleman, default 70
		"I_Soldier_AAR_F",		1, //Asst Autorifleman, default 70
		"I_Soldier_TL_F",		1, //Team leader. default 30
		"I_Soldier_A_F",		1, //Ammo, default 20
		"I_Soldier_M_F",		1, //Marksman, default 20
		"I_Soldier_LAT_F",		1, //PCML, default 20
		"I_Soldier_LAT2_F",		50, //MAAWS? , deault 20
		"I_Soldier_SL_F",		1, //Squad leader, default 15
		"I_Soldier_AAT_F",		1, //Asst AT, default 15
		"I_Soldier_AAA_F",		1, //Asst AA, default 15
		"I_Soldier_AT_F",		1, //Titan AT, default 15
		"I_Soldier_AA_F",		100, //Titan AA, default 15
		"I_medic_F",			1, //Medic, default 15
		"I_Soldier_repair_F",	1, //Repair, default 15
		"I_engineer_F",			1, //engineer, default 15
...
BIS_WL_factionVehicleClasses = [
	...
	[
		...
		"I_APC_Wheeled_03_cannon_F",		25, //Gorgan, default 50
		"I_APC_tracked_03_cannon_F",		25, //Mora, default 50
		"I_LT_01_AT_F",				25, //Nyx AT, default 50
...
BIS_WL_factionAircraftClasses = [
	...
	[
		"I_Plane_Fighter_03_CAS_F",	70, //Indy A-10, default 100
		"I_Heli_light_03_F", 20, //Hellcat with rockets, default 70
		"I_Plane_Fighter_04_F", 100, //A-149 Gryphon. default 50
